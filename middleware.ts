...
export const config = {
  matcher: [
     ...
     * - favicon.ico, manifest.json, icons (public files)
     */
    '/((?!api|_next/static|_next/image|favicon.ico|manifest.json|android-chrome|apple-touch-icon|robots.txt|sitemap.xml).*)',
  ],
};
