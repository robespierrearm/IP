...
export default function DashboardPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50">
      {/* Шапка - ФИОЛЕТОВАЯ СТЕКЛЯННАЯ СВЕТЯЩАЯСЯ (как в настройках) */}
      <div className="backdrop-blur-2xl bg-gradient-to-br from-primary-500/90 via-primary-600/85 to-secondary-600/90 px-4 pb-6 shadow-2xl shadow-primary-500/40" style={{ paddingTop: 'max(1rem, env(safe-area-inset-top))' }}>
